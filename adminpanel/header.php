    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion d-print-none" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                ...
                <div class="sidebar-brand-text mx-3">Service<small>Picker</small></div>
            </a>
            ...
            <li class="nav-item <?php if(PAGE == 'technician'){echo 'active';}?>">
             ...
             <!-- Nav Item - Requesters -->
             <li class="nav-item <?php if(PAGE == 'requester'){echo 'active';}?>">
                <a class="nav-link " href="requester.php">
                <i class="fas fa-users"></i>
                    <span>Requesters</span></a>
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo $_SESSION['aEmail'];?></span>
